...
public class Texto {
    ...
    public static void main(String[] args) {
        printCabecalho("Loja Geraldo Enterprise",30);

    }

    public static String selecionarOpcao(String[] opcoes){
        return selecionarOpcao("Escolha uma opcao ",opcoes);
    }
    public static String selecionarOpcao(String texto,String[] opcoes){
        ...
        while(repete) {
            ...
            if (Arrays.asList(opcoes).contains(entrada)){
                ...
                System.out.println("Opcao inválida! "+entrada+"\n");
            }
        }
        return selecao;
    ...
    public static double readDouble(String texto) {
        try {
            return Double.parseDouble(readString(texto));
        }catch (NumberFormatException e){
            return -1;
        }
    }
